...
import GiftVoucherForm from "../BulkGiftVoucher/GiftVoucherForm";
import ValueVoucherForm from "../BulkValueVoucher/ValueVoucherForm";
import DiscountVoucherForm from "../BulkDiscountVoucher/DiscountVoucherForm";
...
class TableList extends Component {
    state = {
      ...
      handleChangeExpanded = panel => (event, expandedb) => {
        this.setState({
          expandedb: expandedb ? panel : false,
        });
      };
